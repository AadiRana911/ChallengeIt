...
class NotificationDetail extends Component {
  ...
  grabChallenges = () => {
    ...
    try {
      ...
      new Promise((rsl, rej) => {
        this.props.openNotification(formData, this.props.token, rsl, rej);
      })
        .then((res) => {
          console.log(this.props.notifDetail);
          this.props.notifDetail &&
            this.setState({
              videos: this.props.notifDetail.map((item) => {
                return {
                  ...item,
                  loading: true,
                  muted: false,
...
const mapStateToProps = (state) => {
  ...
  return {nearby, token, user, notifDetail, playlists, responses};
};
