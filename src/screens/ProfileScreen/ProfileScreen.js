...
import {ScrollView, View, Text, Dimensions, Image, Animated, TouchableWithoutFeedback, TouchableOpacity, FlatList} from 'react-native';
...
const ProfileScreen = ({translateScreen, paused, setPaused, translateXImg, translateYImg}) => {
    ...
    const results = [
        {url: 'https://image.shutterstock.com/image-photo/islamabad-pakistan-april-25-2019-260nw-1407461093.jpg'}, 
        {url: 'https://i.pinimg.com/originals/ca/76/0b/ca760b70976b52578da88e06973af542.jpg'}, 
        {url: 'https://cdn.pixabay.com/photo/2015/04/23/22/00/tree-736885__340.jpg'}, 
        {url: 'https://images.unsplash.com/photo-1503023345310-bd7c1de61c7d?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&w=1000&q=80'},
        {url: 'https://image.shutterstock.com/image-photo/bright-spring-view-cameo-island-260nw-1048185397.jpg'},
        {url: 'https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcRFU7U2h0umyF0P6E_yhTX45sGgPEQAbGaJ4g&usqp=CAU'},
    ]
    useEffect(() => {
    ...
    return (
        <Animated.ScrollView style = {[styles.container, {transform: [{translateX: translateScreen}]}]} contentContainerStyle ={{flexGrow: 1}}>
            ...
            <View style = {styles.screenIconContainer}>
                <View style = {{alignItems: 'center'}}>
                    <TouchableOpacity>
                        ...
                        <MaterialIcons name = 'reply' color = 'orange' style = {{fontSize: width/20.57142, position: 'absolute', top: '50%', left: '50%',}}/>                    
                    </TouchableOpacity>
                    <Text style = {{fontSize: width/45.71428}}>{responses}</Text>
                </View>
                <View  style = {{alignItems: 'center'}}>
                    <TouchableOpacity>
                        <AntDesign name = 'heart' color = 'orange' style = {{fontSize: width/18.70129}}/>
                    </TouchableOpacity>
            ...
            <View style = {{top: height/4.5, flex: 1,}}>
                <FlatList style = {{width: width-20, top: height/11.67755}}
