    ...
    return (
        <View style = {styles.container}>
            ...
            <TouchableOpacity onPress = {() => navigation.navigate('Notifications')}>
                <FontAwesome name = {'bell'} style = {{fontSize: 26, color: primaryColor}}/>
            </TouchableOpacity>

            <TouchableOpacity onPress = {() => navigation.navigate('Add')}>
                <MaterialCommunityIcons name = {'plus-circle'} style = {{fontSize: 36, color: primaryColor}}/>
            </TouchableOpacity>
            ...
            <TouchableOpacity onPress = {() => navigation.navigate('User')}>
                <FontAwesome5 name = {'user-alt'} style = {{fontSize: 26, color: primaryColor}}/>
            </TouchableOpacity>
        </View>
    );
}
